...
with DAG(
    ...
    def should_process_table(table_name, **context):
        tables_to_process = ["casreport_v_prd_srv","casreport_d_row_item","casreport_mailsitemhdr","casreport_d_item_bd29","casreport_mailsadditionaldata","casreport_lettermailsitem","casreport_mailsitemdtl","casreport_d_service_product"]
