...
with DAG(
    ...
    def should_process_table(table_name, **context):
        tables_to_process = ["bccp_trace_item"]
    ...
    with TaskGroup(group_id="one_to_one_tasks") as one_to_one_tasks:
        for key, value in list(pipeline_params.items()):
            if key in ["bccp_item_vas_property_value", "bccp_value_added_service_item","bccp_item_status","bccp_item","bccp_delivery"]:
                continue
